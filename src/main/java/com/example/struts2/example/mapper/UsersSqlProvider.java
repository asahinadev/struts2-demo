...
public class UsersSqlProvider {
    ...
    public String countByExample(UsersCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("users us");
    ...
    public String selectByExample(UsersCriteria example) {
        ...
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("us.id as us_id");
        } else {
            sql.SELECT("us.id as us_id");
        }
        sql.SELECT("us.username as us_username");
        sql.SELECT("us.password as us_password");
        sql.FROM("users us");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getId() != null) {
            sql.SET("us.id = #{record.id,jdbcType=INTEGER}");
        }
        
        if (record.getUsername() != null) {
            sql.SET("us.username = #{record.username,jdbcType=VARCHAR}");
        }
        
        if (record.getPassword() != null) {
            sql.SET("us.password = #{record.password,jdbcType=VARCHAR}");
        }
